...
public class StrA_ESSout_2A extends Agent {
    ...
    protected void setup() {
        ...
        // 添加行为监听来自SMA的消息
        addBehaviour(new RespondToSMABehaviour());
    }
     ...
     * 行为：响应来自SMA的消息
     */
    private class RespondToSMABehaviour extends CyclicBehaviour {
        ...
        public void action() {
            ...
            if (msg != null) {
                ...
                System.out.println("Received message from SMA: " + content);
                ...
                if (content.contains("Demand")) {
                    ...
                    System.out.println("Sent Discharge Info to SMA -> Discharge Capacity: "
                            + df.format(availableDischargeCapacity) + " kWh, Discharge Bid: "
                            + df.format(dischargeBid) + " $/kWh");
                    ...
                    System.out.println("Sent Charge Info to SMA -> Charge Capacity: "
                            + df.format(availableChargeCapacity) + " kWh, Charge Bid: "
                            + df.format(chargeBid) + " $/kWh");
                }
            } else {
